package me.aravi.weather.widgets
...
import me.aravi.weather.R

@Composable
fun AnimatedThunder(modifier: Modifier = Modifier, durationMillis: Int = 600) {
